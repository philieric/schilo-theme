<?php
/**
 * Template : Archives (catégories, tags, auteurs…)
 */
...
// Map icônes par slug (même mapping que home-fallback)
$icon_map = [
...
// URL de base (sans paged, schilo_sort, schilo_pp)
$base_url = get_term_link( $term instanceof WP_Term ? $term : 0 );
...
<div class="schilo-archive-hero">
    <div class="schilo-container">
        ...
        <div class="schilo-archive-hero__inner">
            <div class="schilo-archive-hero__icon" aria-hidden="true">
                <i class="ti <?php echo esc_attr( $term_icon ); ?>"></i>
            </div>
...
<main id="schilo-main" role="main">
    <div class="schilo-container schilo-archive">
        ...
        <?php if ( have_posts() ) : ?>
            ...
            <div class="schilo-archive-toolbar" role="toolbar">
                <p class="schilo-archive-toolbar__count">
                    <?php
                    printf(
                        esc_html( _n( '%s article', '%s articles', $term_count, 'schilo' ) ),
        ...
        <?php else : ?>
            ...
            <div class="schilo-card" style="margin-top:2rem">
                <div class="schilo-card__body">
                    <p><?php esc_html_e( 'Aucun article trouvé dans cette catégorie.', 'schilo' ); ?></p>
                </div>
            </div>
