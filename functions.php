...
if ( ! defined( 'SCHILO_BUILDER_VERSION' ) ) {
    define( 'SCHILO_BUILDER_VERSION', '1.7.24' );
...
require_once SCHILO_DIR . '/inc/classes/class-schilo-usx-integration.php';
...
require_once SCHILO_DIR . '/inc/classes/class-schilo-advanced-search.php';
...
Schilo_Advanced_Search::init();
Schilo_Translator::init();
Schilo_OTP::init();
Schilo_Usx_Integration::init();
