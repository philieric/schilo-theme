...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (postdivrich) {
            ...
            /* Visible par defaut : c'est ici que vivent les boutons TinyMCE
               (H1-H6/P, menu "Balises" [bib]/[bvc]/[brc]/[bnv]…), invisibles
               pour qui ne pense pas a cliquer sur ce toggle. */
