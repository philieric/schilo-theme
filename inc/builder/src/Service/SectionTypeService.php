...
class SectionTypeService
{
    ...
    public function getDefaultTypes()
    {
        return array(
            ...
            'titre-partie' => array('key'=>'titre-partie','label'=>'Titre de partie','description'=>'Marque le début d’une nouvelle partie dans un article très long. Visible dans le contenu et ajouté au sommaire de l’article.','active'=>1,'view'=>'titre-partie.php','admin_view'=>'titre-simple.php'),
